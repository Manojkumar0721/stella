...
import { 
  searchUsers, sendFriendRequest, fetchPendingRequests, acceptFriendRequest, declineFriendRequest, fetchFriends 
          ...
          <div className="w-full max-w-md bg-[#1e1f20] border border-neutral-800/80 rounded-3xl p-6 shadow-2xl space-y-4">
            ...
            <div className="space-y-2 max-h-60 overflow-y-auto pt-2 custom-scrollbar">
              {isSearching ? (
                ...
                searchResults.map(u => {
                  const isSent = sentRequestsMap[u.uid];
                  return (
                ...
                <div className="text-center py-4 space-y-3">
                  ...
                  {searchQuery.includes('@') && !isQueryAdmin && (
                    ...
                    >
                      ...
                      <span>Send Request to {searchQuery.trim().toLowerCase()}</span>
                    </button>
                  )}
                </div>
              ) : (
